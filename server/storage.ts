    ...
    const stationData: InsertStation[] = [
      {
        ...
        amenities: ["Restrooms", "WiFi", "Coffee Shop"],
        ...
        contactEmail: "info@downtownev.com",
        status: "operational"
      },
      {
        ...
        pricePerKwh: 0.50,
        fastChargingAvailable: true,
        amenities: ["Restrooms", "WiFi", "Restaurant"],
        connectorTypes: ["Type 2", "CCS"],
        imageUrl: "https://images.unsplash.com/photo-1558428818-a3e48549249d?auto=format&fit=crop&w=600&h=300",
        contactPhone: "(415) 555-5678",
        contactEmail: "info@citycentercharging.com",
        status: "maintenance"
      },
      {
        name: "Bay Area Superchargers",
        ...
        pricePerKwh: 0.55,
        fastChargingAvailable: true,
        amenities: ["Restrooms", "WiFi", "Restaurant", "Shopping"],
        connectorTypes: ["CCS", "CHAdeMO", "Tesla", "Type 2"],
        imageUrl: "https://images.unsplash.com/photo-1558428818-a3e48549249d?auto=format&fit=crop&w=600&h=300",
        contactPhone: "(415) 555-9012",
        contactEmail: "support@bayareasuperchargers.com",
